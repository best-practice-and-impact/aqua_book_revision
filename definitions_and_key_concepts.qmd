...
Business critical analysis refers to analysis that has a significant influence over financial and funding decisions, is necessary to the achievement of a departmental business plan or is analysis where an error could have a significant reputational, economic or legal implications. 
...
The decisions log is a register of decisions, whether provided by the commissioner or derived by the analysis. Decisions logs should: 
