...
Design documents describe design of the analysis, including conceptual models to illustrate the analytical problem. They are important as they provide a basis Analytical Assurer to verify whether the analysis meets the specified requirements.  
...
**Accept that uncertainty is inherent** in the inputs and outputs of any piece of analysis. Chapter [8] covers assurance of the analytical stage of the project, including the treatment of uncertainty . Further support can be found in the Uncertainty Toolkit for Analysts in Government (analystsuncertaintytoolkit.github.io) 
