...
Artificial intelligence (AI) attmpts to simulate human intelligence using techniques and methods such as machine learning, natural language processing, and robotics. AI aims to perform tasks that typically require human intelligence, such as problem-solving, decision-making, and language understanding. Artificial Intelligence models are [Black Box Models](#black_box_models)

::: {.callout-tip}
## Black box models <a name="black_box_models"></a> {.unnumbered}
...
decisions with minimal human intervention. ML models are part of the class of models known as [Black Box models](#black_box_models).
...
* **Analyst**  
    + Designs the approach, including the assurance, to meet the commissionerb