...
Culture enables the risk management described [elsewhere in this document](proportionality.html#structured-assessment-of-business-risk-and-complexity).

::: {.callout-tip}
# Assessing and Guiding Organisational Performance
The Department for Education has developed a Quality Assurance Maturity Model (insert hyperlink) here to help government departments and arm's length bodies. It is an objective self-assessment method for assessing  assess an organisation's relative strengths and weaknesses. Orfanisations judge their level of QA maturity in nine assessment areas to give an overall picture of their QA Maturity. It can be used as an aid to setting direction and activities.
