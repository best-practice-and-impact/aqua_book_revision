...
When working with third parties, the Commissioner shall ensure it is clear which role or roles in which stages of the analytical lifecycle that third party is responsible for. See [Roles and Responsibilities](analytical_lifecycle.html#roles_and_responsibilities) for details on the roles.
