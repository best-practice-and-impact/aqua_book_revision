...
A strong quality assurance culture also enables effective [risk management](proportionality.html#structured-assessment-of-business-risk-and-complexity).

::: {.callout-tip}
# Assessing and Guiding Organisational Performance
The Department for Education has developed a [Quality Assurance Maturity Model](https://www.gov.uk/government/publications/analytical-quality-assurance-at-the-department-for-education) to help government departments and arm's length bodies. It is an objective self-assessment method for assessing an organisation's relative strengths and weaknesses. Organisations can judge their level of QA maturity in nine assessment areas to give an overall picture of their QA Maturity. It can be used as an aid to setting direction and activities.
...
The commissioning department remains accountable for ensuring the requirements set out in the AQuA Book are met when working with third parties such as Arm's Length Bodies (ALBs)[^1]. ALBs include executive agencies, non-departmental public bodies and non-ministerial departments.
...
Third parties may set out in a framework document how they will demonstrate compliance with Annex 4.2 of Managing Public Money and the Government Functional Standard for Analysis.

[^1]: See [Cabinet Office guidance on Classification of Public Bodies](https://assets.publishing.service.gov.uk/government/uploads/system/uploads/attachment_data/file/519571/Classification-of-Public_Bodies-Guidance-for-Departments.pdf)
