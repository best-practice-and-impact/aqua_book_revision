...
* consider developing automatic checks to identify if the model is behaving unexpectedly, this is important if the model is likely to be used frequently to make regular decisions; ansd,
* consider whether to refer the model to their ethics committee, or a similar group - see [Data Ethics Framework - Guiodance] (https://www.gov.uk/government/publications/data-ethics-framework/data-ethics-framework-2020).
