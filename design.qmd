...
* carry out a literature review to identify appropriate methods
...
* identify potential modelling methods and document the rationale for selecting their approach
* consider developing automatic checks to identify if the model is behaving unexpectedly  - this is important if the model is likelyto be used frequently to make regular decisions
* consider whether to refer the model to their ethics committee, or similar
