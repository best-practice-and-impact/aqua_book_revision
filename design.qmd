...
* project management approach (for example Agile Software Development[^1], Waterfall planning[^2] or a combination of approaches)    
...
* set out the prediction they wish to make    
...
* consider the appropriate data training, validation and testing strategy for your models - it is usual to design a model with a fraction of the data, validate with a separate portion and then test the final model with the data that was not used in the design    
