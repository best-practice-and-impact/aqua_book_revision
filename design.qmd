...
The Analyst is responsible for documenting the analytical plan in a proportionate manner.
...
The Commissioner should review the approach described in the analytical plan, and confirm that the analytical approach will satisfy their need. They should sign-off the design document.
...
AI and some classes of machine learning methods have opaque algorithms processing their inputs. These belong to a class of models known as “black boxes” - devices, systems, or objects which produce useful information without revealing any information about their internal workings.
...
In this phase the Analyst should:
* define the situation they wish to model:
* the prediction they wish to make
* the data that could be used to make the prodiction
* consider how to treat the data in design and testing - it's usual to design a model with a fraction of the data and then test it with the data that was not used in the design
