...
Consideration may be given to the conditions for the data to continue to be valid. For example, data might be updated or become out of date. In some cases it may be appropriate to spccify a "sunset date" for the data i.e. the date beyond which the data should be refreshed or reviewed. 
