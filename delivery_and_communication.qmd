...
The approver is responsible for the sign-off that confirms that all risks and ethical considerations around the use of black-box models have been addressed. 
...
ALB’s are responsible for publishing their own BCA list, unless agreed otherwise with the department. The ALB’s accounting officer is responsible for ensuring publication and the sponsor department’s accounting officer oversees this.

The BCA list should include all business-critical analysis unless there is an internally documented reason that the analysis should be excluded. This shoud be agreed with the director of analysis (or equivalent) and that agreement should be documented.
