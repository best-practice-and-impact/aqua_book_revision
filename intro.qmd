...
It is also referred to by the [Green Book](https://www.gov.uk/government/publications/the-green-book-appraisal-and-evaluation-in-central-government/the-green-book-2020), the [Magenta Book](https://www.gov.uk/government/publications/the-magenta-book) and other Functional Standards, such as the [Finance Function](https://www.gov.uk/government/publications/government-finance-standards-page) Standards, [Duck Book for Code Quality Assurance](https://github.com/best-practice-and-impact/aqua_book_revision/edit/294-addressing-head-of-profession-feedback/intro.qmd), The National Audit Office - [Quality assurance of models: a guide for audit committees](https://www.nao.org.uk/insights/quality-assurance-of-models/). 
