...
It is also referred to by the [Green Book](https://www.gov.uk/government/publications/the-green-book-appraisal-and-evaluation-in-central-government/the-green-book-2020), the [Magenta Book](https://www.gov.uk/government/publications/the-magenta-book) and other Functional Standards, such as the [Finance Function](https://www.gov.uk/government/publications/government-finance-standards-page) Standards, [Duck Book for Code Quality Assurance](https://github.com/best-practice-and-impact/aqua_book_revision/edit/294-addressing-head-of-profession-feedback/intro.qmd) and the National Audit Office's [Quality assurance of models: a guide for audit committees](https://www.nao.org.uk/insights/quality-assurance-of-models/). 

## Who the AQuA Book is for

This edition has been developed for Government Analysis and is intended for anyone who commissions, uses, conducts, or assures analysis. While it is designed with government needs in mind, the guidance is broadly applicable. It covers the full process of producing analysis that is robust, reliable, and fit for purpose.
...
The first four chapters of this book cover definitions and themes, while the second half of the book goes into more detail on the [analytical life cycle](https://best-practice-and-impact.github.io/aqua_book_revision/analytical_lifecycle.html). This can be pictured as follows:
![Figure 1 - The analytical cycle](analytical_lifecycle_diagram.svg)

::: {.callout-note}
The image shows a flowchart of the analytical life cycle, which includes four main stages:    

1. Engagement and Scoping ([Chapter 6](https://best-practice-and-impact.github.io/aqua_book_revision/engagement_and_scoping.html))
2. Design ([Chapter 7](https://best-practice-and-impact.github.io/aqua_book_revision/design.html))
3. Analysis ([Chapter 8](https://best-practice-and-impact.github.io/aqua_book_revision/analysis.html))
4. Delivery and Communication ([Chapter 9](https://best-practice-and-impact.github.io/aqua_book_revision/delivery_and_communication.html))    

The image emphasises that:    
* The process is often iterative, meaning stages may repeat or happen out of order    
* Proportionality ([Chapter 3](https://best-practice-and-impact.github.io/aqua_book_revision/proportionality.html)) should be considered at every stage    
...
It is important to accept that uncertainty is inherent in the inputs and outputs of any piece of analysis. Chapters [5 to 9](https://best-practice-and-impact.github.io/aqua_book_revision/analytical_lifecycle.html) cover the treatment of uncertainty in each analytical phase.    
...
Objective: Effective engagement and suitable challenge reduce the risk of bias and enable the Commissioner and the Analyst to be clear about the interpretation of results.    
