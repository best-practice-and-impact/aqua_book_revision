...
* **‘may’** denotes approval i.e. it's a good idea but not mandatory or advosory
...
### Analysis with RIGOUR: An acronym some users find helpful to consider when completing analysis is RIGOUR. 
