...
The AQuA Book describes what you need to do but not how to do it, although it does contain many worked examples. Large organisations will have their own processes and practices covering “the how”. These can be assessed using a Quality Assurance Maturity Model - hyper link required.
