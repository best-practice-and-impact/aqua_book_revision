...
[^1]: [Black box](https://en.wikipedia.org/wiki/Black_box): system which can be viewed in terms of its inputs and outputs (or transfer characteristics), without any knowledge of its internal workings. [For more information](https://onlinelibrary.wiley.com/doi/10.1002/tea.21817)
