...
The engagement and scoping stage provides the Analyst with an understanding of the Commissioner's requirements. In some cases, the Commissioner may present a well-defined problem, while in other instances, the engagement stage may require problem structuring methods. Techniques such as the Strategic Choice Approach, Rich Pictures and Systems Thinking can help the Analyst and Commissioner to reach a joint understanding of the problem (see the [Systems Thinking Toolkit](https://www.gov.uk/government/publications/systems-thinking-for-civil-servants/toolkit) for further information). Through the engagement, the Analyst and Commissioner will be in a position to define the scope of the project in terms of the context and bounds of the analysis.

In addition the engagement stage should lead to agreement between the Analyst and Commissioner around the outputs to be delivered, including acceptable levels of accuracy, precision and margins of error.
